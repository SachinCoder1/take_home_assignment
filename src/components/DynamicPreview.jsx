...
const DynamicPreview = React.forwardRef(({ videoRef, cropperRef, cropPosition, cropSize, isCropperActive }, ref) => {
    ...
    // Ensure the preview updates as the video plays or when the cropper moves
    useEffect(() => {
        if (!isCropperActive) {
            return;
        };
            ...
            <h4 className="pb-2 font-bold text-gray-400">Preview</h4>
            {
                isCropperActive ?
                    ...
                    <div className="flex flex-col items-center justify-center h-full text-gray-400 gap-y-4">
                        ...
                        <p className="text-base font-bold text-white">Preview not available</p>
